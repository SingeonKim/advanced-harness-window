...
스킬 트리거를 위한 바로 사용 가능한 regex 및 glob 패턴. 스킬에 맞게 복사하고 커스터마이즈하세요.
...
- [TRIGGER_TYPES.md](TRIGGER_TYPES.md) - 상세한 트리거 문서
- [SKILL_RULES_REFERENCE.md](SKILL_RULES_REFERENCE.md) - 완전한 스키마
